        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageSize = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoles_Workspaces_WorkspaceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MasterKeyBundle = table.Column<SecretKeyBundle>(type: "jsonb", nullable: true),
                    RecoveryMasterKeyBundle = table.Column<SecretKeyBundle>(type: "jsonb", nullable: true),
                    RecoveryKeyBundle = table.Column<SecretKeyBundle>(type: "jsonb", nullable: true),
                    AsymmetricEncKeyBundle = table.Column<KeyPairBundle>(type: "jsonb", nullable: true),
                    SigningKeyBundle = table.Column<KeyPairBundle>(type: "jsonb", nullable: true),
                    WorkspaceId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FolderKeyBundle = table.Column<SecretKeyBundle>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_NormalizedName_WorkspaceId",
                table: "AspNetRoles",
                columns: new[] { "NormalizedName", "WorkspaceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_WorkspaceId",
                table: "AspNetRoles",
                column: "WorkspaceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Folders_Id_WorkspaceId",
                table: "Folders",
                columns: new[] { "Id", "WorkspaceId" },
                unique: true);
