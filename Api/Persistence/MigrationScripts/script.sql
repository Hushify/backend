...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230301094756_Init') THEN
...
BEGIN
    ...
    CREATE TABLE "AspNetUsers" (
        ...
        "Salt" text NULL,
        "MasterKeyBundle" jsonb NULL,
        "RecoveryMasterKeyBundle" jsonb NULL,
        "RecoveryKeyBundle" jsonb NULL,
        "AsymmetricEncKeyBundle" jsonb NULL,
        "SigningKeyBundle" jsonb NULL,
        "WorkspaceId" uuid NOT NULL,
...
BEGIN
    ...
    CREATE TABLE "Folders" (
        ...
        "FolderKeyBundle" jsonb NOT NULL,
...
BEGIN
    ...
    VALUES ('20230301094756_Init', '7.0.2');
    END IF;
END $EF$;
COMMIT;
